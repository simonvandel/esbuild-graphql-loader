...
var generateDocumentNodeString = (graphqlDocument, mapDocumentNode) => {
  ...
  if ((documentNodeToUse == null ? void 0 : documentNodeToUse.loc) !== void 0) {
...
var generateContentsFromGraphqlString = (graphqlString, mapDocumentNode) => {
  var _a, _b;
  let toModify = graphql_tag.default(graphqlString);
  console.log("before: ", JSON.stringify(toModify));
  console.log("before JSON:", (_a = toModify.loc) == null ? void 0 : _a.source);
  toModify.loc.source = {
    body: graphqlString,
  ...
  const graphqlDocument = toModify;
  console.log("after:", (_b = graphqlDocument.loc) == null ? void 0 : _b.source);
